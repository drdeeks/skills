...
MIGRATION_OPTION_METADATA: Dict[str, Dict[str, str]] = {
    ...
    "skills": {
        "label": "User skills",
        "description": "Copy OpenClaw skills into ${HERMES_DIR:-~/.hermes}/skills/openclaw-imports/.",
    },
    "tts-assets": {
        "label": "TTS assets",
        "description": "Copy compatible workspace TTS assets into ${HERMES_DIR:-~/.hermes}/tts/.",
    },
    "discord-settings": {
    ...
    "shared-skills": {
        "label": "Shared skills",
        "description": "Copy shared OpenClaw skills from ${OPENCLAW_DIR:-~/.openclaw}/skills/ into Hermes.",
    },
    "daily-memory": {
...
class Migrator:
    ...
    def generate_migration_notes(self) -> None:
        ...
        notes.extend([
            ...
            "- Review `${HERMES_DIR:-~/.hermes}/config.yaml` for any adjustments",
            "",
        ])
...
def main() -> int:
    ...
    if migrated:
        ...
        for item in migrated:
            ...
            if dest.startswith(str(report["target_root"])):
                dest = "${HERMES_DIR:-~/.hermes}/" + dest[len(str(report["target_root"])) + 1:]
    ...
    if args.execute:
        print()
        print("  Next steps:")
        print("    1. Review ${HERMES_DIR:-~/.hermes}/config.yaml")
