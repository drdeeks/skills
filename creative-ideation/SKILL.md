...
Each constraint produces a structured set of ideas. The output follows this template for consistency and clarity across all creative sessions.
...
A worked example showing how the constraint-based ideation process produces concrete, buildable project ideas from abstract prompts.
...
|--------|---------|-------|
| `scripts/main.py` | creative-ideation script | Run with python3 |

## Key References

- **Skill**: [references/SKILL.md](references/SKILL.md)
- **Full Prompt Library**: [references/full-prompt-library.md](references/full-prompt-library.md)
...
- Constraint-Based Creativity: https://wttdotm.com/prompts.html
- Creative Coding Resources: https://www.creative-coding.org
