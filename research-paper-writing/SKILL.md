...
Templates in `templates/` directory. Templates are available in the research-paper-templates skill.
...
|--------|---------|-------|
| `scripts/main.py` | research-paper-writing script | Run with python3 |

## Key References

- **Reviewer Guidelines**: [references/reviewer-guidelines.md](references/reviewer-guidelines.md)
- **Citation Workflow**: [references/citation-workflow.md](references/citation-workflow.md)
- **Skill**: research-paper-writing
- **Experiment Patterns**: [references/experiment-patterns.md](references/experiment-patterns.md)
- **Writing Guide**: [references/writing-guide.md](references/writing-guide.md)
- **Checklists**: [references/checklists.md](references/checklists.md)
- **Paper Types**: [references/paper-types.md](references/paper-types.md)
- **Autoreason Methodology**: [references/autoreason-methodology.md](references/autoreason-methodology.md)
- **Human Evaluation**: [references/human-evaluation.md](references/human-evaluation.md)
...
- Exa MCP: https://mcp.exa.ai
- Overleaf: https://overleaf.com
- Git + LaTeX: https://git-scm.com
- NeurIPS Templates: https://github.com/neurips/neurips-2025
- ICML Templates: https://github.com/icml/icml2026
- ICLR Templates: https://github.com/ICLR/ICLR2026
- ACL Templates: https://github.com/acl-org/acl-2025
- AAAI Templates: https://github.com/AAAI/AAAI-2026
- COLM Templates: https://github.com/COLM/COLM2025
...
See the research-paper-templates skill for compilation instructions.
