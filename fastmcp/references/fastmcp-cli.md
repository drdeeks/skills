...
- [Inspect a Server](#inspect-a-server)
- [List and Call Tools](#list-and-call-tools)
- [Discover Named MCP Servers](#discover-named-mcp-servers)
- [Install into MCP Clients](#install-into-mcp-clients)
