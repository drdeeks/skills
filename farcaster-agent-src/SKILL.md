...
- `${OPENCLAW_CONFIG_DIR}/farcaster-credentials.json` (if OpenClaw is installed)
...
|---------|---------|-----------|-------------|
| Neynar API | Farcaster profile lookups | 1,000 req/day | $49-499/mo |
| Farcaster Hub | On-chain data access | Self-hosted | — |
