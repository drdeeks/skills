---
name: blockchain
description: "Blockchain development skills for Base and Solana networks. Includes smart contract deployment, wallet management, and on-chain interactions."
license: MIT
metadata:
  category: blockchain
  tags:
...
Blockchain development skills for Base and Solana networks.

## Supported Networks

### Base (Ethereum L2)
- Smart contract deployment
- Wallet management via MPC
...
|--------|---------|-------|
| `scripts/main.py` | blockchain script | Run with python3 |
