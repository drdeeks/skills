...
# enterprise-blueprint is self-reliant: generate_checklist.py uses THIS unless
# LOOP_ENFORCER_ROOT explicitly points at an external loop-enforcer. Keep in
# sync when upgrading (mirrors skill-creator's own scripts/chain.py).
