...
"""
    ...
    def _generate_phase_validators(self, crew_dir, project_dir):
        ...
        chain_files = list((crew_dir / ".chain").glob("*-blueprint.json"))
        if not chain_files:
...
*Generated by crew-manager.py — autonomous-crew-integration skill*
"""
