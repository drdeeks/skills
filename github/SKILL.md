...
|--------|---------|-------|
| `scripts/main.py` | github script | Run with python3 |
...
- **GitHub CLI Commands**: [references/gh-cli-commands.md](references/gh-cli-commands.md)
- **Git Workflow**: [references/git-workflow.md](references/git-workflow.md)
