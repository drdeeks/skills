...
This category contains skills related to leisure.

## Subskills

- **find-nearby** — Location-based discovery for nearby points of interest, events, and activities
...
|--------|---------|-------|
| `scripts/main.py` | leisure script | Run with python3 |
