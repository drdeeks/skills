...
- Add a comment noting migration is needed
...
|--------|---------|-------|
| `scripts/validate.py` | convert-farcaster-miniapp-to-app script | Run with python3 |
| `scripts/main.py` | convert-farcaster-miniapp-to-app script | Run with python3 |
