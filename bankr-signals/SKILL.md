...
|---------|---------|-----------|-------------|
| Bankr Signals API | Signal tracking & leaderboard | Basic free | Pro tiers |

## Key References

- **Signal Tracking**: [references/signal-tracking.md](references/signal-tracking.md)
- **Leaderboard API**: [references/leaderboard-api.md](references/leaderboard-api.md)
- **Heartbeat Protocol**: [references/heartbeat.md](references/heartbeat.md)