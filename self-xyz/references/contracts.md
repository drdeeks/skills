...
- [SelfVerificationRoot](#selfverificationroot)
- [Verification Flow](#verification-flow)
- [Hub V2 Addresses](#hub-v2-addresses)
- [Registering a Verification Config](#registering-a-verification-config)
- [Working with userDefinedData](#working-with-userdefineddata)
- [GenericDiscloseOutputV2](#genericdiscloseoutputv2)
- [Scope & Replay Prevention](#scope-&-replay-prevention)
