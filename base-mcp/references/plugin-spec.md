...
- [Runtime Routing Primitives](#runtime-routing-primitives)
- [Required Body Sections](#required-body-sections)
- [How to Author a New Plugin](#how-to-author-a-new-plugin)
- [How to Adapt an Existing Plugin](#how-to-adapt-an-existing-plugin)
- [Plugin Skeleton Template](#plugin-skeleton-template)
- [Overview](#overview)
...
- [Existing Plugin Conformance](#existing-plugin-conformance)
