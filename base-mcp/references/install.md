...
- [Claude (Claude.ai web, Claude Desktop, iOS, Android)](#claude-claude.ai-web,-claude-desktop,-ios,-android)
- [ChatGPT](#chatgpt)
- [Claude Code](#claude-code)
- [Codex](#codex)
- [Cursor](#cursor)
- [Hermes](#hermes)
- [Authorization (first use)](#authorization-first-use)
...
Manual install — edit `${HERMES_DIR:-~/.hermes}/config.yaml`:
