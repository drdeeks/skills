---
name: devops
description: 'Category for skills related to devops. Contains: deploy-skills-to-agents,
...
This category contains skills related to devops.

## Subskills

- deploy-skills-to-agents
- webhook-subscriptions
- openclaw-hermes-docker
- openclaw-hermes-mcp-integration
...
|--------|---------|-------|
| `scripts/main.py` | devops script | Run with python3 |
...
- CI/CD Best Practices: https://docs.docker.com/build/ci/github-actions/
