...
- [OASF (Open Agent Skill Framework)](#oasf-open-agent-skill-framework)
- [x402 Payment Protocol](#x402-payment-protocol)
- [Webhook Integration (8004scan)](#webhook-integration-8004scan)
- [WalletConnect v2](#walletconnect-v2)
- [Agent Registration Best Practices](#agent-registration-best-practices)
...
- Session file at `${HOME}/.8004skill/wc-storage.json` (relay metadata only)
