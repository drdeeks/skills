...
- [Mainnet Chains (23)](#mainnet-chains-23)
- [Testnet Chains (24)](#testnet-chains-24)
- [Chain Resolution Rules](#chain-resolution-rules)
- [Top Chains by Agent Count](#top-chains-by-agent-count)
...
2. **Config file**: `${HOME}/.8004skill/config.json` → `activeChain` field
