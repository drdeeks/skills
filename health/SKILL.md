...
|--------|---------|-------|
| `scripts/main.py` | health script | Run with python3 |
...
- **BCI Devices**: [references/bci-devices.md](references/bci-devices.md)
- **Neurofeedback Protocols**: [references/neurofeedback-protocols.md](references/neurofeedback-protocols.md)

## Sources

- [Muse SDK Documentation](https://developer.interaXon.com/)
- [OpenBCI Documentation](https://openbci.com/docs)
- [Emotiv SDK Documentation](https://emotiv.github.io/)